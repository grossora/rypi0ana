/**
 * \file MCTopo_BG_ccnopi0_Sig.h
 *
 * \ingroup Pi0Ana
 * 
 * \brief Class def header for a class MCTopo_BG_ccnopi0_Sig
 *
 * @author ryan
 */
...
#ifndef LARLITE_MCTOPO_BG_CCNOPI0_H
#define LARLITE_MCTOPO_BG_CCNOPI0_H
...
namespace larlite {
  /**
     \class MCTopo_BG_ccnopi0_Sig
     User custom analysis class made by SHELL_USER_NAME
   */
  class MCTopo_BG_ccnopi0 : public ana_base{
  
  public:

    /// Default constructor
    MCTopo_BG_ccnopi0(){ _name="MCTopo_BG_ccnopi0"; _fout=0;_bothccnc=false; _ccnc=1; _sig = true;  _topo=2; _fid=0.0; _showerenergy=0; _showerdetenergy=0; _showercontain=0;}

    /// Default destructor
    virtual ~MCTopo_BG_ccnopi0(){}

    /** IMPLEMENT in MCTopo_BG_ccnopi0_Sig.cc!
