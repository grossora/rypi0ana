#ifndef LARLITE_MCTOPO_BG_CCNOPI0_CXX
#define LARLITE_MCTOPO_BG_CCNOPI0_CXX

#include "MCTopo_BG_ccnopi0.h"

namespace larlite {

  bool MCTopo_BG_ccnopi0::initialize() {

    return true;
  }
  
  bool MCTopo_BG_ccnopi0::analyze(storage_manager* storage) {
	_nEvt++;
...
//        auto ev_mcshower = storage->get_data<event_mcshower>("mcreco");// Get the mcshower info
  ...
  bool MCTopo_BG_ccnopi0::finalize() {
