...
#my_anaunit._mgr.AddCfgFile('/home/ryan/LARLITE/trunk/UserDev/SelectionTool/ERTool/dat/ertool_default_reco.cfg')
...
my_ana = ertool.ERAnaMassInspect()
...
my_proc.set_ana_output_file("pi0_ins_reco.root")
